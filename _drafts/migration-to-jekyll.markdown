...
WordPress is a free and open source platform for building websites and content management. You can self-host WordPress for free, use the hosted free-tier from WordPress.com, or pay for other hosted options.

Jekyll is a static site generator that powers GitHub Pages (it has no dependency on GitHub Pages for hosting and can be used independently as well). With GitHub Pages, you can configure a GitHub repository that is used as the source for your site. GitHub actions automatically handle the building and publishing of your site. Hosting on GitHub Pages is also free.

# Why Migrate

## Cons of WordPress

For my use case, WordPress is overkill.
...
![GitHub-Pages Release Subscription](../assets/github-pages-release-subscription.png)
